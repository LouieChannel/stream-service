    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    byte[] data = Encoding.UTF8.GetBytes($"1,{element.ItemArray[1]},{element.ItemArray[2]},{element.ItemArray[3]},{element.ItemArray[4]},{element.ItemArray[5]},{element.ItemArray[6]},{element.ItemArray[7]}");
